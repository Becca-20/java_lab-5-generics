...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Pair<String, Integer> pair1 = new Pair<>("key, pair 1", 10);
        Pair<Integer, String> pair2 = new Pair<>(20, "value, pair 2");
        Pair<String, String> pair3 = new Pair<>("key, pair 3", "value, pair 3");
